...
public class AppNodesBuilder {
    ...
    public TabPane buildTabPane(Object nodeId, Pane parentPane, 
            String styleClass, String[] tabNames, boolean enabled){
        //buildTabPane(CSG_MAIN_TAB_PANE, workspace, CLASS_CSG_PANE, tabNames, ENABLED);
    ...
    public ScrollPane buildScrollPane(Object nodeId, Pane parentPane,
    ...
    public ImageView buildImage(Object nodeId, String location, Pane parentPane,
            String styleClass,  boolean enabled) {
        ImageView image = new ImageView("file:" + location);
        
        initNode(nodeId, image, parentPane, styleClass, enabled);
        
        return image;
    }
    
    public DatePicker buildDatePicker(Object nodeId, Pane parentPane,
            String styleClass, boolean enabled){
